...
addon_info = AddonInfo(
	...
	addon_name="remotePlusPlus",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Remote++"),
	# Add-on description
...
Fix duplicate disconnect confirmation dialogs."""),
	...
	addon_sourceURL="https://github.com/cary-rowen/remotePlusPlus",
...
pythonSources: list[str] = ["addon/globalPlugins/remotePlusPlus/*.py"]
